...
for v in node_list:
    self_ppr_value = self_ppr_obj.calc_self_ppr_by_random_walk(source_id=v, count=1000, alpha=0.95)
    self_ppr_dic[v] = self_ppr_value


# txt file に出力
f = open('../alpha_dir/' + dataset_name + '/self_ppr_95.txt', 'a', encoding='UTF-8')
