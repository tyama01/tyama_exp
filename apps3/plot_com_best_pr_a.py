...
# /usr/bin/python3 /Users/tyama/tyama_exp/apps3/plot_com_best_pr_a.py
...
for focus_id in com_top3_nodes_dic[com_id]:
    ...
    ax.scatter(x/100, pr_value, label=ranking, s=10)
    ax.plot(x/100, pr_value)
